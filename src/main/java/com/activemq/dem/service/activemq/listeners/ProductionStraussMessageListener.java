...
@Log4j
@Component
public class ProductionStraussMessageListener
{
	@JmsListener(destination = MessageQueuesName.PRODUCTION_STRAUSS_MESSAGE_QUEUE, containerFactory = "jmsListenerContainerFactory")
