...
@Log4j
@Component
public class ProductionWcoMessageListener
{
	@JmsListener(destination = MessageQueuesName.PRODUCTION_WCO_MESSAGE_QUEUE, containerFactory = "jmsListenerContainerFactory")
