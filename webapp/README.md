...
app/                    --> all of the source files for the application
  ...
  view1/                --> the view1 view template and logic
    ...
    view1.js              --> the com.activemq.dem.controller logic
    view1_test.js         --> tests of the com.activemq.dem.controller
  view2/                --> the view2 view template and logic
    view2.html            --> the partial template
    view2.js              --> the com.activemq.dem.controller logic
    view2_test.js         --> tests of the com.activemq.dem.controller
...
which we run with the [Karma][karma] test runner. We provide a Karma com.activemq.dem.configuration file to run them.

* The com.activemq.dem.configuration is found at `karma.conf.js`.
...
* The com.activemq.dem.configuration is found at `e2e-tests/protractor-conf.js`.
...
project contains a Travis com.activemq.dem.configuration file, `.travis.yml`, which will cause Travis to run your
